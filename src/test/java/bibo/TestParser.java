...
public class TestParser {
    ...
    public static void setupClass() {
        ...
        try {
            Method setCommand = InputParser.class.getDeclaredMethod("setCommand", Command.class);
    ...
    public void testParseTaskDescription_emptyDescription_exceptionThrown() {
        try {
            ...
            Method parseTaskDescription = InputParser.class.getDeclaredMethod("parseTaskDescription", String.class);
            ...
            try {
                ...
                assertEquals(e.getCause().getClass(), TaskFormatException.class);
            }
    ...
    public void testParseTaskDescription_invalidDateTime_exceptionThrown() {
        try {
            ...
            Method parseDateTime = InputParser.class.getDeclaredMethod("parseDateTime", String.class);
